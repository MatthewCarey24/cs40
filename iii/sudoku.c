...
/********** no_col_dups ********
 *
 * determine whether there are duplicates in any columns of the board
 *
 * Parameters: 
 *      UArray2_T array: UArray2 instance containing the values of a board
 * Return: 
 *      A boolean indicating if there are no duplicates in the 
 *      columns               
 * Expects
...
/********** no_row_dups ********
 *
 * determine whether there are duplicates in any rows of the board
 *
 * Parameters: 
 *      UArray2_T array: UArray2 instance containing the values of a board
 * Return: 
 ...
 *
 * determine whether or not there are duplicates in any submaps
 *
 * Parameters: 
 *      UArray2_T array: UArray2 instance containing the values of a board  
 * Return: 
